...
```
Agent(
  prompt="Read /home/user/integrated-scanner/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/integrated-scanner/.claude/gsd-core/templates/VALIDATION.md`
