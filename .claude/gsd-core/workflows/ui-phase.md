...
```markdown
Read /home/user/integrated-scanner/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/integrated-scanner/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/integrated-scanner/.claude/agents/gsd-ui-checker.md for instructions.
