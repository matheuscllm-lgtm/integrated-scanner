...
<execution_context>
@/home/user/integrated-scanner/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/integrated-scanner/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
