...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/integrated-scanner/.claude/.gsd-surface.json`
(sibling to `/home/user/integrated-scanner/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/integrated-scanner/.claude/skills/gsd-*/`.
...
(`/home/user/integrated-scanner/.claude`), NOT the skills sub-directory (`/home/user/integrated-scanner/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/user/integrated-scanner/.claude` as `configDir`. The skill dirs themselves live at
`/home/user/integrated-scanner/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/user/integrated-scanner/.claude}"
SCOPE="global"
...
(i.e. `/home/user/integrated-scanner/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/integrated-scanner/.claude/.gsd-surface.json`
Install profile marker: `/home/user/integrated-scanner/.claude/.gsd-profile`
Skill dirs: `/home/user/integrated-scanner/.claude/skills/gsd-*/`
Engine module: `/home/user/integrated-scanner/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/integrated-scanner/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
