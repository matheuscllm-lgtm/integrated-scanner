...
<required_reading>
@/home/user/integrated-scanner/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/integrated-scanner/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/integrated-scanner/.claude
                  → checks /home/user/integrated-scanner/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/integrated-scanner/.claude/gsd-core
                  → writes to /home/user/integrated-scanner/.claude/gsd-core/hooks/
...
@/home/user/integrated-scanner/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/integrated-scanner/.claude/gsd-core/references/common-bug-patterns.md
