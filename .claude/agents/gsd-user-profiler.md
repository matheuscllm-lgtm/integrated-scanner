...
<reference>
@/home/user/integrated-scanner/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/integrated-scanner/.claude/gsd-core/references/user-profiling.md` to load:
