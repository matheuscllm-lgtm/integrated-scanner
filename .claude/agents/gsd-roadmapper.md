...
Reference full template: `/home/user/integrated-scanner/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/integrated-scanner/.claude/gsd-core/templates/state.md`.
