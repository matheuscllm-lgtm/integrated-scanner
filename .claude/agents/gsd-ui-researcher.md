...
Use template from `/home/user/integrated-scanner/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/integrated-scanner/.claude/gsd-core/templates/UI-SPEC.md`
